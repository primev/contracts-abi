...
//
// Solidity: function slash(uint256 amt, address provider, address bidder, uint256 residualBidAfterDecay) returns()
func (_Providerregistry *ProviderregistryTransactor) Slash(opts *bind.TransactOpts, amt *big.Int, provider common.Address, bidder common.Address, residualBidAfterDecay *big.Int) (*types.Transaction, error) {
	return _Providerregistry.contract.Transact(opts, "slash", amt, provider, bidder, residualBidAfterDecay)
}

// Slash is a paid mutator transaction binding the contract method 0x8b6e1f8d.
//
// Solidity: function slash(uint256 amt, address provider, address bidder, uint256 residualBidAfterDecay) returns()
func (_Providerregistry *ProviderregistrySession) Slash(amt *big.Int, provider common.Address, bidder common.Address, residualBidAfterDecay *big.Int) (*types.Transaction, error) {
	return _Providerregistry.Contract.Slash(&_Providerregistry.TransactOpts, amt, provider, bidder, residualBidAfterDecay)
}

// Slash is a paid mutator transaction binding the contract method 0x8b6e1f8d.
//
// Solidity: function slash(uint256 amt, address provider, address bidder, uint256 residualBidAfterDecay) returns()
func (_Providerregistry *ProviderregistryTransactorSession) Slash(amt *big.Int, provider common.Address, bidder common.Address, residualBidAfterDecay *big.Int) (*types.Transaction, error) {
	return _Providerregistry.Contract.Slash(&_Providerregistry.TransactOpts, amt, provider, bidder, residualBidAfterDecay)
}
