...
//
// Solidity: function retrieveFunds(bytes32 commitmentDigest, address provider, uint256 risidualBidAfterDecay) returns()
func (_Bidderregistry *BidderregistryTransactor) RetrieveFunds(opts *bind.TransactOpts, commitmentDigest [32]byte, provider common.Address, risidualBidAfterDecay *big.Int) (*types.Transaction, error) {
	return _Bidderregistry.contract.Transact(opts, "retrieveFunds", commitmentDigest, provider, risidualBidAfterDecay)
}

// RetrieveFunds is a paid mutator transaction binding the contract method 0x05c27ed6.
//
// Solidity: function retrieveFunds(bytes32 commitmentDigest, address provider, uint256 risidualBidAfterDecay) returns()
func (_Bidderregistry *BidderregistrySession) RetrieveFunds(commitmentDigest [32]byte, provider common.Address, risidualBidAfterDecay *big.Int) (*types.Transaction, error) {
	return _Bidderregistry.Contract.RetrieveFunds(&_Bidderregistry.TransactOpts, commitmentDigest, provider, risidualBidAfterDecay)
}

// RetrieveFunds is a paid mutator transaction binding the contract method 0x05c27ed6.
//
// Solidity: function retrieveFunds(bytes32 commitmentDigest, address provider, uint256 risidualBidAfterDecay) returns()
func (_Bidderregistry *BidderregistryTransactorSession) RetrieveFunds(commitmentDigest [32]byte, provider common.Address, risidualBidAfterDecay *big.Int) (*types.Transaction, error) {
	return _Bidderregistry.Contract.RetrieveFunds(&_Bidderregistry.TransactOpts, commitmentDigest, provider, risidualBidAfterDecay)
}
